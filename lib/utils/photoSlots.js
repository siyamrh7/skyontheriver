...
export const PHOTO_SLOTS = [
  ...
  { key: 'schipA', label: 'Grote foto links', pagina: 'Het schip', formaat: 'Liggend, min. 1400 × 900 px', bestand: 'ms-joy-stairs2.jpg' },
  ...
  { key: 'schipD', label: 'Onderste rij — links', pagina: 'Het schip', formaat: 'Liggend, min. 800 × 550 px', bestand: 'ms-joy-stairs.jpg' },
  { key: 'schipE', label: 'Onderste rij — midden', pagina: 'Het schip', formaat: 'Liggend, min. 800 × 550 px', bestand: 'ms-joy-restaurant-panorama.jpg' },
