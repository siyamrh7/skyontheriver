    ...
    <div className="section-pad grid-gastheer" style={{ maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ position: 'relative' }}>
        ...
        <img
          ...
          alt="Denny Braaf"
          style={{ position: 'relative', width: '100%', height: 520, objectFit: 'cover', objectPosition: 'center 20%', display: 'block' }}
        />
      </div>
      <div>
        ...
        <p style={{ fontSize: 16.5, lineHeight: 1.85, color: 'rgba(232,228,218,0.78)', margin: '0 0 18px' }}>
          Drie dagen lang is Denny Braaf uw gastheer aan boord. Van de muzikale begeleiding bij het diner op vrijdagavond tot de grote dinershow op zaterdag: hij brengt de sterren naar de rivier.
        </p>
        <p style={{ fontSize: 16.5, lineHeight: 1.85, color: 'rgba(232,228,218,0.78)', margin: '0 0 32px' }}>
          Na het diner neemt DJ Barry Brand het over in de bistro en danst u tot in de kleine uurtjes — twee avonden lang.
        </p>
